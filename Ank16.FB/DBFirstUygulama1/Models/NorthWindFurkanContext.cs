...
public partial class NorthWindFurkanContext : DbContext
{
    public NorthWindFurkanContext()
    {
    }

    public NorthWindFurkanContext(DbContextOptions<NorthWindFurkanContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<SunOlanlar> SunOlanlars { get; set; }

    public virtual DbSet<Supplier> Suppliers { get; set; }

    public virtual DbSet<Territory> Territories { get; set; }

    public virtual DbSet<VwHesapAdet> VwHesapAdets { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=ANK3-YZLMORT-14\\MSSQLSERVERANK16; database=NorthWindFurkan;trusted_connection=true;trustservercertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SunOlanlar>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("sunOlanlar");
        ...
        modelBuilder.Entity<VwHesapAdet>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vwHesapAdet");
            ...
            entity.Property(e => e.EmployeeId).HasColumnName("EmployeeID");
            entity.Property(e => e.Hesap).HasColumnType("money");
        });
