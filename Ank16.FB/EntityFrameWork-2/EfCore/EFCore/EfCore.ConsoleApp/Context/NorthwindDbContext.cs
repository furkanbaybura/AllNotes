...
public partial class NorthwindDbContext : DbContext
{
    ...
    public virtual DbSet<CloneCategory> CloneCategories { get; set; }
    ...
    public virtual DbSet<Tablo1> Tablo1s { get; set; }

    public virtual DbSet<Tablo2> Tablo2s { get; set; }

    public virtual DbSet<Territory> Territories { get; set; }

    public virtual DbSet<VwCategoryOnlyHasPicture> VwCategoryOnlyHasPictures { get; set; }

    public virtual DbSet<VwSiparisUrunMusteriListesi> VwSiparisUrunMusteriListesis { get; set; }

    public virtual DbSet<VwTedarikciBilgileri> VwTedarikciBilgileris { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder.UseSqlServer("ANK3-YZLMORT-14\\MSSQLSERVERANK16;Database=NorthwindMt;Trusted_Connection=true;Encrypt=false;MultipleActiveResultSets=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CloneCategory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__CloneCat__3214EC2773F0B417");

            entity.ToTable("CloneCategory");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__DERSLER__3214EC2781F743BA");
        ...
        modelBuilder.Entity<Ogrencidersleri>(entity =>
        {
            ...
            entity.HasOne(d => d.Ogrenci).WithMany()
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OGRENCIL__3214EC276AC55373");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TABLO_1__3214EC2712607107");

            entity.ToTable("TABLO_1", tb => tb.HasTrigger("trgTablo1"));
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TABLO_2__3214EC2741E8EF73");

            entity.ToTable("TABLO_2");
        ...
        modelBuilder.Entity<VwCategoryOnlyHasPicture>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vwCategoryOnlyHasPictures");
        ...
        modelBuilder.Entity<VwSiparisUrunMusteriListesi>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vwSiparisUrunMusteriListesi");
        ...
        modelBuilder.Entity<VwTedarikciBilgileri>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vwTedarikciBilgileri");

            entity.Property(e => e.KontakAdiSoyadi).HasMaxLength(30);
            entity.Property(e => e.KontakUnvani).HasMaxLength(30);
            entity.Property(e => e.SehirAdi).HasMaxLength(15);
            entity.Property(e => e.SirketAdi).HasMaxLength(40);
            entity.Property(e => e.TedarikciId)
                .ValueGeneratedOnAdd()
                .HasColumnName("TedarikciID");
            entity.Property(e => e.UlkeAdi).HasMaxLength(15);
        });
