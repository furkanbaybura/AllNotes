    ...
    public partial class Example : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    KategoriAdi = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    Aciklama = table.Column<string>(type: "ntext", nullable: true),
                    Resim = table.Column<byte[]>(type: "image", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__CloneCat__3214EC2773F0B417", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__DERSLER__3214EC2781F743BA", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ADISOYADI = table.Column<string>(type: "nvarchar(101)", maxLength: 101, nullable: true, computedColumnSql: "(([ADI]+' ')+[SOYADI])", stored: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__OGRENCIL__3214EC276AC55373", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BILGI = table.Column<string>(type: "varchar(200)", unicode: false, maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__TABLO_1__3214EC2712607107", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TABLO_2__3214EC2741E8EF73", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK__OGRENCIDE__DERS___2DE6D218",
                        column: x => x.OGRENCI_ID,
                        principalTable: "OGRENCILER",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK__OGRENCIDE__DERS___2EDAF651",
                        column: x => x.DERS_ID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OGRENCIDERSLERI_DERS_ID",
                table: "OGRENCIDERSLERI",
                column: "DERS_ID");

            migrationBuilder.CreateIndex(
                name: "IX_OGRENCIDERSLERI_OGRENCI_ID",
                table: "OGRENCIDERSLERI",
                column: "OGRENCI_ID");
